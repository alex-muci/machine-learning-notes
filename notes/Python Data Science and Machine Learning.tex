...
\title{REVIEW NOTES: \\
	...
	%\footnotetext{We gratefully acknowledge the inputs of Domenico Picone and \ldots} 
	}
...
\date{April 2017}  % First draft: November 2016             
...
\medskip
\noindent \textit{Keywords}: Systematic trading, algorithms, risk factors, API %\LaTeX; papers with no content.
